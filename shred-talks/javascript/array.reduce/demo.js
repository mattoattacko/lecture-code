...
let newthing = numbers.reduce( (accumulator, val, idx) => {
...
let names = pokemon.reduce( (acc, val, idx) => {
  acc.push( val.name );
  return acc;
}, [] );
